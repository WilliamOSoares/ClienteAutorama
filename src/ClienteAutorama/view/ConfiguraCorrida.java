    ...
    private void avancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_avancarActionPerformed
        ...
        if(i==0){
            ...
            if(s.equals("OK")){    
                ...
                gerenciador.setTelaConfig(this);
                gerenciador.enviaConfigFan(tQuali.getValue().toString()+":00", nVoltas.getValue().toString(), local.getNome()+" - "+local.getPais(),local.getRecordista(), local.getTempoRecordPista(),participantes);
